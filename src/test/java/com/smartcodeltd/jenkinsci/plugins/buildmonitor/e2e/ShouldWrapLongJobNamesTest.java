...
class ShouldWrapLongJobNamesTest {
    ...
    private static final List<String> NAMES = List.of(
            "MyOrganization-MyTeam-MyApplication-MyJob-with-slash",
            "MyOrganization.MyTeam.MyApplication.MyJob-with-slash",
            "MyOrganization_MyTeam_MyApplication_MyJob-with-slash",
            "MyOrganizationMyTeamMyApplicationMyJobWithNoSeparators");
    ...
    void test(Page p, JenkinsRule j) {
        ...
        NAMES.forEach(name -> monitor.getJob(name).hasNameContainedWithinCell());
    }
}
